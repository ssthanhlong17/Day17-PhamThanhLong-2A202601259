...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        context_result = self.client.thread.get_user_context(thread_id=thread_id)
        context = getattr(context_result, "context", "") or ""

        # The Context Block is the primary long-term result.  Include matching
        # facts when available so recency and provenance remain inspectable.
        try:
            ...
            fact_text = ""
        return join_nonempty((context, fact_text), sep="\n\n")
    ...
    def retrieve_episodic(self, user_id: str, query: str) -> str:
        ...
        # Keep several distinct episodes under the tight episodic budget.
    ...
    def retrieve_semantic(self, graph_id: str, query: str) -> str:
        ...
        try:
            ...
            # Older graph indexes may not expose raw episodes; nodes still
            # provide a useful, graph-scoped semantic fallback.
            results = self.client.graph.search(
                graph_id=graph_id,
                query=cap_query(query),
                scope="nodes",
